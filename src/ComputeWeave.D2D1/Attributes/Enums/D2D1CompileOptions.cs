...
public enum D2D1CompileOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>Using this flag makes shaders incompatible with the constant buffer loading code produced by ComputeWeave.D2D1.</para>
    ...
    /// </remarks>
#if !SOURCE_GENERATOR
    [Experimental("CMPWEXP0001", UrlFormat = "https://github.com/routersys/ComputeWeave")]
#endif
    ...
    /// <summary>
    /// The default options for shaders compiled by ComputeWeave.D2D1. Specifically, this combination of options
