...
unsafe partial struct PixelShaderEffect
{
    ...
    public static HRESULT GetResourceTextureManager0Impl(IUnknown* effect, byte* data, uint dataSize, uint* actualSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager0Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager1Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager2Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager3Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager4Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager5Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager6Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager7Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager8Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager9Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager10Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager11Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager12Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager13Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager14Impl(IUnknown* effect, byte* data, uint dataSize)
    {
    ...
    /// <inheritdoc cref="D2D1_PROPERTY_BINDING.getFunction"/>
    [UnmanagedCallersOnly]
    public static HRESULT SetResourceTextureManager15Impl(IUnknown* effect, byte* data, uint dataSize)
    {
