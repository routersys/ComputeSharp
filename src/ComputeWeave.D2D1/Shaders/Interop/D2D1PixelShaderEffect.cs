...
using ComputeWeave.D2D1.Extensions;
using ComputeWeave.D2D1.Interop.Effects;
using ComputeWeave.D2D1.Shaders.Interop.Buffers;
using ComputeWeave.D2D1.Shaders.Interop.Effects.ResourceManagers;
using ComputeWeave.D2D1.Shaders.Interop.Effects.TransformMappers;
using ComputeWeave.D2D1.Shaders.Loaders;
using ComputeWeave.Win32;

namespace ComputeWeave.D2D1.Interop;
...
public static unsafe class D2D1PixelShaderEffect
{
    ...
    /// should only ever be used implicitly by the ComputeWeave infrastructure, or in advanced scenarios where effects are registered manually.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// For instance, an application could allow plugins to create effects through the <c>ComputeWeave.D2D1</c> APIs, and to then create an effect registration
    ...
    /// context and using a different (potentially incompatible) version of <c>ComputeWeave.D2D1</c>, the two could still work side by side with no issues.
    /// </para>
    /// <para>
