...
internal unsafe partial struct ID2D1EffectContext
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext*, Guid*, void**, int>)(lpVtbl[4]))((ID2D1EffectContext*)Unsafe.AsPointer(ref this), effectId, effect);
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<ID2D1EffectContext*, Guid*, int>)(lpVtbl[14]))((ID2D1EffectContext*)Unsafe.AsPointer(ref this), shaderId);
    }
