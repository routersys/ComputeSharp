...
public abstract unsafe partial class Buffer<T> : IReferenceTrackedObject, IGraphicsResource, ID3D12ReadOnlyResource, IResourceGenerationOwner, IGenerationBoundResource
    where T : unmanaged
{
    /// <summary>
