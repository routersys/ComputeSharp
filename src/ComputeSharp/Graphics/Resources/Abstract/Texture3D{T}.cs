...
public abstract unsafe partial class Texture3D<T> : IReferenceTrackedObject, IGraphicsResource, ID3D12ReadWriteResource, ID3D12ComputeFenceTrackedResource, IResourceGenerationOwner, IGenerationBoundResource
    where T : unmanaged
{
    /// <summary>
