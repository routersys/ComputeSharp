...
partial class ReadWriteTexture1D<T>
{
    ...
    /// </summary>
    private sealed unsafe class ReadOnly : ReferenceTrackedObject, IReadOnlyTexture1D<T>, ID3D12ReadOnlyResource, ID3D12ComputeFenceTrackedResource, IGenerationBoundResource
    {
        /// <summary>
