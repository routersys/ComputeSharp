...
partial class ReadWriteTexture2D<T, TPixel>
{
    ...
    /// </summary>
    private sealed unsafe class ReadOnly : ReferenceTrackedObject, IReadOnlyNormalizedTexture2D<TPixel>, ID3D12ReadOnlyResource, ID3D12ComputeFenceTrackedResource, IGenerationBoundResource
    {
        /// <summary>
