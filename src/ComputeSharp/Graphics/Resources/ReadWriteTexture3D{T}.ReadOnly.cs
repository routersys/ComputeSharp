...
partial class ReadWriteTexture3D<T>
{
    ...
    /// </summary>
    private sealed unsafe class ReadOnly : ReferenceTrackedObject, IReadOnlyTexture3D<T>, ID3D12ReadOnlyResource, ID3D12ComputeFenceTrackedResource, IGenerationBoundResource
    {
        /// <summary>
