...
partial class ReadWriteTexture1D<T, TPixel>
{
    ...
    /// </summary>
    private sealed unsafe class ReadOnly : ReferenceTrackedObject, IReadOnlyNormalizedTexture1D<TPixel>, ID3D12ReadOnlyResource, ID3D12ComputeFenceTrackedResource
    {
        /// <summary>
