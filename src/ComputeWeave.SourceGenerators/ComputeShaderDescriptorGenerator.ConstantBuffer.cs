...
partial class ComputeShaderDescriptorGenerator
{
    ...
    private static class ConstantBuffer
    {
        ...
        public static void WriteSyntax(ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.WriteLine($"static unsafe void global::ComputeWeave.Descriptors.IComputeShaderDescriptor<{typeName}>.LoadConstantBuffer<TLoader>(in {typeName} shader, ref TLoader loader, int x, int y, int z)");
            ...
            using (writer.WriteBlock())
            {
                ...
                {
                    writer.WriteLine("global::System.Runtime.CompilerServices.Unsafe.SkipInit(out global::ComputeWeave.Generated.ConstantBuffer buffer);");
                }
                else
                {
                    // Otherwise, let the generated marshaller create an initialized instance of the constant buffer type
                    writer.WriteLine("global::ComputeWeave.Generated.ConstantBufferMarshaller.FromManaged(in shader, out global::ComputeWeave.Generated.ConstantBuffer buffer);");
                }
                ...
                writer.WriteLine("loader.LoadConstantBuffer(new global::System.ReadOnlySpan<byte>(&buffer, sizeof(global::ComputeWeave.Generated.ConstantBuffer)));");
            }
        }
    }
}