...
/// <param name="FieldType">The fully qualified type name of the field.</param>
/// <param name="UnspeakableName">The unspeakable name of the field, if present.</param>
public sealed record ResourceInfo(string FieldName, string FieldType, string? UnspeakableName);