...
partial class ComputeShaderDescriptorGenerator
{
    ...
    partial class ResourceDescriptorRanges
    {
        ...
        public static void WriteSyntax(ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.Write($"static global::System.ReadOnlyMemory<global::ComputeWeave.Interop.ResourceDescriptorRange> global::ComputeWeave.Descriptors.IComputeShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.ResourceDescriptorRanges => ");
            ...
            {
                writer.WriteLine("global::ComputeWeave.Generated.Data.ResourceDescriptorRanges;");
            }
        }
            ...
            ImmutableHashSetBuilder<string> usingDirectives)
        {
            ...
            _ = usingDirectives.Add("global::ComputeWeave.Interop");
