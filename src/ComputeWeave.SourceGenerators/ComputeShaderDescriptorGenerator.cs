...
public sealed partial class ComputeShaderDescriptorGenerator : IIncrementalGenerator
{
    ...
    /// </summary>
    private const string GeneratorName = "ComputeWeave.ComputeShaderDescriptorGenerator";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        IncrementalValuesProvider<ShaderInfo> shaderInfoWithNoHlslBytecode =
            ...
            .ForAttributeWithMetadataName(
                "ComputeWeave.GeneratedComputeShaderDescriptorAttribute",
        ...
        context.RegisterSourceOutput(outputInfo, static (context, item) =>
        {
            ...
            item.Hierarchy.WriteSyntax(
                state: item,
                writer: writer,
                baseTypes: [$"global::ComputeWeave.Descriptors.IComputeShaderDescriptor<{item.Hierarchy.Hierarchy[0].QualifiedName}>"],
            ...
            {
                writer.WriteLine();
                writer.WriteLine("namespace ComputeWeave.Generated");
