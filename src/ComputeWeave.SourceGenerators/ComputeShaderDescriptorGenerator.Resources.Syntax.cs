...
partial class ComputeShaderDescriptorGenerator
{
    ...
    partial class Resources
    {
        ...
        public static void WriteSyntax(ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.WriteLine($"static void global::ComputeWeave.Descriptors.IComputeShaderDescriptor<{typeName}>.LoadGraphicsResources<TLoader>(in {typeName} shader, ref TLoader loader)");
            ...
            using (writer.WriteBlock())
            {
                ...
                writer.WriteLine("global::ComputeWeave.Generated.GraphicsResourcesLoader.LoadGraphicsResources(in shader, ref loader);");
            }
        }
            ...
            ImmutableHashSetBuilder<string> usingDirectives)
        {
            ...
            _ = usingDirectives.Add("global::ComputeWeave.Descriptors");
