...
partial class ComputeShaderDescriptorGenerator
{
    ...
    {
        INamedTypeSymbol computeShaderSymbol = compilation.GetTypeByMetadataName("ComputeWeave.IComputeShader")!;
        INamedTypeSymbol pixelShaderSymbol = compilation.GetTypeByMetadataName("ComputeWeave.IComputeShader`1")!;
