    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("ComputeWeave.IComputeShader") is not { } computeShaderSymbol ||
                ...
                context.Compilation.GetTypeByMetadataName("ComputeWeave.Descriptors.IComputeShaderDescriptor`1") is not { } computeShaderDescriptorSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.GeneratedComputeShaderDescriptorAttribute") is not { } generatedComputeShaderDescriptorAttributeSymbol)
            {
                return;
            }
