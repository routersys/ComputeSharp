...
public sealed class ExcedeedComputeShaderDispatchDataSizeAnalyzer : DiagnosticAnalyzer
{
    ...
    /// <param name="computeShaderSymbol">The <see cref="INamedTypeSymbol"/> for <c>"ComputeWeave.IComputeShader"</c>.</param>
    /// <param name="pixelShaderSymbol">The <see cref="INamedTypeSymbol"/> for <c>"ComputeWeave.IComputeShader`1"</c>.</param>
