...
partial class PipelineDescriptorGenerator
{
    ...
    private static void WriteResourceSetRegistration(InteropResourceSetInfo item, IndentedTextWriter writer)
    {
        ...
        writer.WriteLine($"private readonly global::ComputeWeave.ComputeInteropResourceSetRuntime {ResourceSetRuntimeFieldName};");
        writer.WriteLine();
        ...
        writer.WriteLine($"private {item.TypeName}(global::ComputeWeave.GraphicsDevice device, global::ComputeWeave.ComputeInteropDomain domain)");
        ...
        using (writer.WriteBlock())
        {
            ...
            writer.Write(
                ...
                "global::ComputeWeave.ComputeInteropResourceSetRuntime.Create(device, domain, CanonicalDescriptor, [");
        ...
        writer.WriteGeneratedAttributes(GeneratorName);
        writer.WriteLine($"public static {item.TypeName} Create(global::ComputeWeave.GraphicsDevice device, global::ComputeWeave.ComputeInteropDomain domain)");
    ...
    private static void WriteResourceSetSlot(SharedTextureSlotSyntaxInfo slot, IndentedTextWriter writer)
    {
        ...
        writer.WriteGeneratedAttributes(GeneratorName);
        writer.WriteLine(
            $"{slot.BindingAccessibility} global::ComputeWeave.ComputeResourceBinding<{slot.BindingTypeName}> " +
        ...
        writer.WriteGeneratedAttributes(GeneratorName);
        writer.WriteLine(
            $"{slot.ViewAccessibility} global::ComputeWeave.BorrowedExternalTextureView<{slot.ViewTypeName}> " +
        ...
        writer.WriteGeneratedAttributes(GeneratorName);
        writer.WriteLine(
            $"{slot.ViewAccessibility} global::ComputeWeave.ExternalTextureLease<{slot.ViewTypeName}> " +
