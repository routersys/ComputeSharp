...
partial class HlslKnownProperties
{
    ...
    private static partial Dictionary<string, string> BuildKnownResourceIndexers()
    {
        return new()
        {
            [$"ComputeWeave.ReadOnlyTexture2D`1.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.ReadOnlyTexture2D`2.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.ReadWriteTexture2D`1.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.ReadWriteTexture2D`2.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.IReadOnlyTexture2D`1.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.IReadWriteTexture2D`1.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.IReadOnlyNormalizedTexture2D`1.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.IReadWriteNormalizedTexture2D`1.this[{typeof(int).FullName}, {typeof(int).FullName}]"] = "int2",
            [$"ComputeWeave.ReadOnlyTexture3D`1.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3",
            [$"ComputeWeave.ReadOnlyTexture3D`2.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3",
            [$"ComputeWeave.ReadWriteTexture3D`1.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3",
            [$"ComputeWeave.ReadWriteTexture3D`2.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3",
            [$"ComputeWeave.IReadOnlyTexture3D`1.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3",
            [$"ComputeWeave.IReadWriteTexture3D`1.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3",
            [$"ComputeWeave.IReadOnlyNormalizedTexture3D`1.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3",
            [$"ComputeWeave.IReadWriteNormalizedTexture3D`1.this[{typeof(int).FullName}, {typeof(int).FullName}, {typeof(int).FullName}]"] = "int3"
        };
    }
    ...
    private static partial Dictionary<string, (int Rank, int Axis)> BuildKnownSizeAccessors()
    {
        ...
        return new()
        {
            ...
            ["ComputeWeave.Resources.Texture3D`1.Width"] = (3, 0),
            ["ComputeWeave.Resources.Texture3D`1.Height"] = (3, 1),
            ["ComputeWeave.Resources.Texture3D`1.Depth"] = (3, 2),
            ["ComputeWeave.IReadOnlyTexture1D`1.Width"] = (1, 0),
            ["ComputeWeave.IReadOnlyTexture2D`1.Width"] = (2, 0),
            ["ComputeWeave.IReadOnlyTexture2D`1.Height"] = (2, 1),
            ["ComputeWeave.IReadOnlyTexture3D`1.Width"] = (3, 0),
            ["ComputeWeave.IReadOnlyTexture3D`1.Height"] = (3, 1),
            ["ComputeWeave.IReadOnlyTexture3D`1.Depth"] = (3, 2),
            ["ComputeWeave.IReadOnlyNormalizedTexture1D`1.Width"] = (1, 0),
            ["ComputeWeave.IReadOnlyNormalizedTexture2D`1.Width"] = (2, 0),
            ["ComputeWeave.IReadOnlyNormalizedTexture2D`1.Height"] = (2, 1),
            ["ComputeWeave.IReadOnlyNormalizedTexture3D`1.Width"] = (3, 0),
            ["ComputeWeave.IReadOnlyNormalizedTexture3D`1.Height"] = (3, 1),
            ["ComputeWeave.IReadOnlyNormalizedTexture3D`1.Depth"] = (3, 2),
            ["ComputeWeave.IReadWriteNormalizedTexture1D`1.Width"] = (1, 0),
            ["ComputeWeave.IReadWriteNormalizedTexture2D`1.Width"] = (2, 0),
            ["ComputeWeave.IReadWriteNormalizedTexture2D`1.Height"] = (2, 1),
            ["ComputeWeave.IReadWriteNormalizedTexture3D`1.Width"] = (3, 0),
            ["ComputeWeave.IReadWriteNormalizedTexture3D`1.Height"] = (3, 1),
            ["ComputeWeave.IReadWriteNormalizedTexture3D`1.Depth"] = (3, 2)
        };
    }
