...
internal static class ResourcePlanGrammar
{
    ...
    /// </summary>
    private const string BufferTypeMetadataName = "ComputeWeave.Resources.Buffer`1";

    /// <summary>
    /// The fully qualified metadata name of the 2D texture base type.
    /// </summary>
    private const string Texture2DTypeMetadataName = "ComputeWeave.Resources.Texture2D`1";
