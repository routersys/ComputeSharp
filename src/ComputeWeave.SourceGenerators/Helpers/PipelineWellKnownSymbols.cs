    ...
    INamedTypeSymbol sharedTextureSlot)
{
    ...
    {
        if (compilation.GetTypeByMetadataName("ComputeWeave.ComputePipelineHostAttribute") is not { } pipelineHostAttribute ||
            ...
            compilation.GetTypeByMetadataName("ComputeWeave.ComputeSharedTextureAttribute") is not { } sharedTextureAttribute ||
            compilation.GetTypeByMetadataName("ComputeWeave.IGraphicsResource") is not { } graphicsResourceInterface ||
            compilation.GetTypeByMetadataName("ComputeWeave.ComputeContext") is not { } computeContext ||
            compilation.GetTypeByMetadataName("ComputeWeave.ComputeResourceSlot`1") is not { } resourceSlot ||
            compilation.GetTypeByMetadataName("ComputeWeave.ComputeResourceGroupSlot`1") is not { } resourceGroupSlot ||
            compilation.GetTypeByMetadataName("ComputeWeave.SharedTextureSlot`3") is not { } sharedTextureSlot)
        {
            symbols = null;
