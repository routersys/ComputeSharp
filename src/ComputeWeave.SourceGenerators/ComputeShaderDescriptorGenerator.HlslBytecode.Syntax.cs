...
partial class ComputeShaderDescriptorGenerator
{
    ...
    partial class HlslBytecode
    {
        ...
        public static void WriteSyntax(ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.Write($"static global::System.ReadOnlyMemory<byte> global::ComputeWeave.Descriptors.IComputeShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.HlslBytecode => ");
            ...
            {
                writer.WriteLine("global::ComputeWeave.Generated.HlslBytecodeMemoryManager.Instance.Memory;");
            }
        }
