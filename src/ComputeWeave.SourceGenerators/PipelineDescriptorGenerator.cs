...
public sealed partial class PipelineDescriptorGenerator : IIncrementalGenerator
{
    ...
    /// </summary>
    private const string GeneratorName = "ComputeWeave.PipelineDescriptorGenerator";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        IncrementalValuesProvider<PipelineHostInfo> hostInfo =
            ...
            .ForAttributeWithMetadataName(
                "ComputeWeave.ComputePipelineHostAttribute",
        ...
        IncrementalValuesProvider<InteropResourceSetInfo> resourceSetInfo =
            context.SyntaxProvider
            .ForAttributeWithMetadataName(
                "ComputeWeave.ComputeInteropResourceSetAttribute",
                static (node, _) => node is ClassDeclarationSyntax,
        ...
        IncrementalValuesProvider<ResourceGroupPlanInfo> resourceGroupInfo =
            context.SyntaxProvider
            .ForAttributeWithMetadataName(
                "ComputeWeave.ComputeResourceGroupAttribute",
                static (node, _) => node is ClassDeclarationSyntax,
