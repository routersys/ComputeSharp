...
partial class ComputeShaderDescriptorGenerator
{
    ...
    private static partial class HlslBytecode
    {
        ...
        public static CompileOptions GetCompileOptions(INamedTypeSymbol structDeclarationSymbol)
        {
            ...
            if (structDeclarationSymbol.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.CompileOptionsAttribute", out AttributeData? attributeData) ||
                structDeclarationSymbol.ContainingAssembly.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.CompileOptionsAttribute", out attributeData))
            {
