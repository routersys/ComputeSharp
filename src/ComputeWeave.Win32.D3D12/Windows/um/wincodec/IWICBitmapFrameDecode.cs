...
internal unsafe partial struct IWICBitmapFrameDecode
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<IWICBitmapFrameDecode*, WICRect*, uint, uint, byte*, int>)(lpVtbl[7]))((IWICBitmapFrameDecode*)Unsafe.AsPointer(ref this), prc, cbStride, cbBufferSize, pbBuffer);
    }
