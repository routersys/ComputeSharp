...
internal static partial class HlslKnownKeywords
{
    ...
    private static HashSet<string> BuildKnownKeywordsMap()
    {
        ...
        [
            ...
            "RAYTRACING_PIPELINE_FLAG_SKIP_PROCEDURAL_PRIMITIVES", "STATE_OBJECT_FLAG_ALLOW_STATE_OBJECT_ADDITIONS",
            ...
            "STATE_OBJECT_FLAG_ALLOW_LOCAL_DEPENDENCIES_ON_EXTERNAL_DEFINITONS", "__TIMESTAMP__",
            "ALL_MEMORY", "BARRIER_SEMANTIC_FLAG", "DEVICE_SCOPE", "DispatchNodeInputRecord", "GROUP_SCOPE",
            "GROUP_SHARED_MEMORY", "GROUP_SYNC", "GroupNodeInputRecords", "GroupNodeOutputRecords",
            "MEMORY_TYPE_FLAG", "NODE_INPUT_MEMORY", "NODE_OUTPUT_MEMORY", "NodeOutput", "NodeOutputArray",
            "RWDispatchNodeInputRecord", "RWGroupNodeInputRecords", "RWThreadNodeInputRecord",
            "ThreadNodeInputRecord", "ThreadNodeOutputRecords", "UAV_MEMORY",
