...
internal static partial class HlslKnownKeywords
{
    ...
    private static HashSet<string> BuildKnownKeywordsMap()
    {
        ...
        [
            ...
            "ALL_MEMORY", "BARRIER_SEMANTIC_FLAG", "CANDIDATE_NON_OPAQUE_TRIANGLE", "CANDIDATE_PROCEDURAL_PRIMITIVE",
            "CANDIDATE_TYPE", "COMMITTED_NOTHING", "COMMITTED_PROCEDURAL_PRIMITIVE_HIT", "COMMITTED_STATUS",
            "COMMITTED_TRIANGLE_HIT", "DEVICE_SCOPE", "DispatchNodeInputRecord", "GROUP_SCOPE", "GROUP_SHARED_MEMORY",
            "GROUP_SYNC", "GroupNodeInputRecords", "GroupNodeOutputRecords", "HIT_KIND_NONE",
            "HIT_KIND_TRIANGLE_BACK_FACE", "HIT_KIND_TRIANGLE_FRONT_FACE", "MEMORY_TYPE_FLAG", "NODE_INPUT_MEMORY",
            "NODE_OUTPUT_MEMORY", "NodeOutput", "NodeOutputArray", "RAYTRACING_PIPELINE_FLAG_NONE",
            "RAYTRACING_PIPELINE_FLAG_SKIP_PROCEDURAL_PRIMITIVES", "RAYTRACING_PIPELINE_FLAG_SKIP_TRIANGLES",
            "RAY_FLAG", "RAY_FLAG_ACCEPT_FIRST_HIT_AND_END_SEARCH", "RAY_FLAG_CULL_BACK_FACING_TRIANGLES",
            "RAY_FLAG_CULL_FRONT_FACING_TRIANGLES", "RAY_FLAG_CULL_NON_OPAQUE", "RAY_FLAG_CULL_OPAQUE",
            "RAY_FLAG_FORCE_NON_OPAQUE", "RAY_FLAG_FORCE_OPAQUE", "RAY_FLAG_NONE", "RAY_FLAG_SKIP_CLOSEST_HIT_SHADER",
            "RAY_FLAG_SKIP_PROCEDURAL_PRIMITIVES", "RAY_FLAG_SKIP_TRIANGLES", "RWDispatchNodeInputRecord",
            "RWGroupNodeInputRecords", "RWTexture2DMS", "RWTexture2DMSArray", "RWThreadNodeInputRecord",
            "RasterizerOrderedTexture1DArray", "SAMPLER_FEEDBACK_MIN_MIP", "SAMPLER_FEEDBACK_MIP_REGION_USED",
            ...
            "STATE_OBJECT_FLAG_ALLOW_STATE_OBJECT_ADDITIONS", "Technique", "ThreadNodeInputRecord",
            "ThreadNodeOutputRecords", "UAV_MEMORY", "_Alignas", "_Alignof", "_Atomic", "_Complex",
            ...
            "__SHADER_TARGET_MINOR", "__SHADER_TARGET_STAGE", "__TIMESTAMP__", "__TIME__", "__VERSION__", "__alignof",
            "__alignof__",
