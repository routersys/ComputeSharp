...
using HlslBytecodeInfoKey = ComputeWeave.D2D1.SourceGenerators.Models.HlslBytecodeInfoKey;
using HlslCompilationException = ComputeWeave.D2D1.FxcCompilationException;
using ID3DBlob = Windows.Win32.Graphics.Direct3D.ID3DBlob;
#else
using HlslBytecodeInfoKey = ComputeWeave.SourceGenerators.Models.HlslBytecodeInfoKey;
using HlslCompilationException = ComputeWeave.SourceGenerators.Dxc.DxcCompilationException;
