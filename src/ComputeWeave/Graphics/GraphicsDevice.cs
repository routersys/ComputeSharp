...
using static ComputeWeave.Win32.DXGI_ADAPTER_FLAG;
...
public sealed unsafe partial class GraphicsDevice : IReferenceTrackedObject
{
    ...
    {
        return AppContext.GetData("ComputeWeave.MaximumPendingCommandListCount") switch
        {
    ...
    void IReferenceTrackedObject.DangerousOnDispose()
    {
        ...
        TraceOutstandingNativeReferences();
        SaveFinalFenceCompletedValues();
