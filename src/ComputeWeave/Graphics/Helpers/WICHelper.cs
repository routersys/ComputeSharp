...
namespace ComputeWeave.Graphics.Helpers;
...
internal sealed unsafe class WICHelper
{
        ...
        where T : unmanaged
    {
        ...
        wicStream.Get()->InitializeFromBufferWriter(writer).Assert();
        ...
        where T : unmanaged
    {
        ...
        wicBitmapFrameEncode.Get()->Commit().Assert();
        wicBitmapEncoder->Commit().Assert();
    }
}