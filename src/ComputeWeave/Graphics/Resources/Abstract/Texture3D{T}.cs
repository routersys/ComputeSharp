...
public abstract unsafe partial class Texture3D<T> : IReferenceTrackedObject, IGraphicsResource, ID3D12ReadWriteResource, IResourceGenerationOwner, IGenerationBoundResource
    where T : unmanaged
{
    /// <summary>
