...
public abstract unsafe partial class TransferTexture1D<T> : IReferenceTrackedObject, IGraphicsResource, IResourceGenerationOwner, IGenerationBoundResource, IMemoryOwner<T>
    where T : unmanaged
{
    /// <summary>
    ...
    private sealed class MemoryManager(TransferTexture1D<T> buffer) : MemoryManager<T>
    {
        ...
        /// </summary>
        private readonly TransferTexture1D<T> buffer = buffer;
