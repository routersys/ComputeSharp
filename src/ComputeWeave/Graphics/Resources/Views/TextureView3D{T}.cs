    ...
    where T : unmanaged
{
    ...
    {
        throw new NotSupportedException("ComputeWeave.TextureView3D<T>.Equals(object) is not supported");
    }
    ...
    {
        throw new NotSupportedException("ComputeWeave.TextureView3D<T>.GetHashCode() is not supported");
    }

    /// <inheritdoc/>
    public override string ToString()
    {
        return $"ComputeWeave.TextureView3D<{typeof(T)}>[{Width}, {Height}, {Depth}]";
    }
