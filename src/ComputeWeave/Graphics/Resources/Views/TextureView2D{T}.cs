    ...
    where T : unmanaged
{
    ...
    {
        throw new NotSupportedException("ComputeWeave.TextureView2D<T>.Equals(object) is not supported");
    }
    ...
    {
        throw new NotSupportedException("ComputeWeave.TextureView2D<T>.GetHashCode() is not supported");
    }

    /// <inheritdoc/>
    public override string ToString()
    {
        return $"ComputeWeave.TextureView2D<{typeof(T)}>[{Width}, {Height}]";
    }
