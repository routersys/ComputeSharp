...
public sealed class InvalidD2DResourceTextureIndexAttributeUseAnalyzer : DiagnosticAnalyzer
{
    ...
    public override unsafe void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DResourceTextureIndexAttribute") is not { } d2DResourceTextureIndexAttributeSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2D1ResourceTexture1D`1") is not { } d2D1ResourceTexture1DSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2D1ResourceTexture2D`1") is not { } d2D1ResourceTexture2DSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2D1ResourceTexture3D`1") is not { } d2D1ResourceTexture3DSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DInputCountAttribute") is not { } d2DInputCountAttributeSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.ID2D1PixelShader") is not { } d2D1PixelShaderSymbol)
            {
                return;
            }
