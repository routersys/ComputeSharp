...
public sealed class InvalidShaderTypeCompileOptionsAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DCompileOptionsAttribute") is not { } d2DCompileOptionsAttributeSymbol)
            {
                return;
            }
            ...
            context.RegisterSymbolAction(context =>
            {
                ...
                if (!typeSymbol.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.D2D1.D2DCompileOptionsAttribute", out AttributeData? attributeData))
                {
                    return;
                }
