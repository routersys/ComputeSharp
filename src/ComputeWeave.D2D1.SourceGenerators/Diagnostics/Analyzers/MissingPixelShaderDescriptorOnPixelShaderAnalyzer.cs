...
public sealed class MissingPixelShaderDescriptorOnPixelShaderAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.ID2D1PixelShader") is not { } d2D1PixelShaderSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor`1") is not { } d2D1PixelShaderDescriptorSymbol ||
