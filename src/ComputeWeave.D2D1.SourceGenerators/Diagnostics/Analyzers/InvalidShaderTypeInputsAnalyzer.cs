...
public sealed class InvalidShaderTypeInputsAnalyzer : DiagnosticAnalyzer
{
    ...
    public override unsafe void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DInputCountAttribute") is not { } d2DInputCountAttributeSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DInputSimpleAttribute") is not { } d2DInputSimpleAttributeSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DInputComplexAttribute") is not { } d2DInputComplexAttributeSymbol ||
