...
public sealed class D2DEnableRuntimeCompilationOnTypeAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DShaderProfileAttribute") is not { } d2DShaderProfileAttributeSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeWeave.D2D1.D2DEnableRuntimeCompilationAttribute") is not { } d2DEnableRuntimeCompilationAttributeSymbol ||
