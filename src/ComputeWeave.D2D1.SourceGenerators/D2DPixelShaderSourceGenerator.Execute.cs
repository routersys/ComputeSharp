...
partial class D2DPixelShaderSourceGenerator
{
    ...
    private static partial class Execute
    {
        ...
        {
            if (methodSymbol.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.D2D1.D2DPixelShaderSourceAttribute", out AttributeData? attributeData) &&
        ...
        {
            if (methodSymbol.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.D2D1.D2DShaderProfileAttribute", out AttributeData? attributeData))
            {
                return (D2D1ShaderProfile)attributeData.ConstructorArguments[0].Value!;
            }

            if (methodSymbol.ContainingAssembly.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.D2D1.D2DShaderProfileAttribute", out attributeData))
            {
                return (D2D1ShaderProfile)attributeData.ConstructorArguments[0].Value!;
            }
        ...
        {
            if (methodSymbol.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.D2D1.D2DCompileOptionsAttribute", out AttributeData? attributeData))
            {
                return (D2D1CompileOptions)attributeData.ConstructorArguments[0].Value!;
            }

            if (methodSymbol.ContainingAssembly.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.D2D1.D2DCompileOptionsAttribute", out attributeData))
            {
                return (D2D1CompileOptions)attributeData.ConstructorArguments[0].Value!;
            }
