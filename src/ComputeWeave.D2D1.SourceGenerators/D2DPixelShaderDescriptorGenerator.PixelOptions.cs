...
partial class D2DPixelShaderDescriptorGenerator
{
    ...
    private static class PixelOptions
    {
        ...
        {
            if (structDeclarationSymbol.TryGetAttributeWithFullyQualifiedMetadataName("ComputeWeave.D2D1.D2DPixelOptionsAttribute", out AttributeData? attributeData))
            {
        ...
        public static void WriteSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            {
                true => $"global::ComputeWeave.D2D1.D2D1PixelOptions.{info.PixelOptions}",
                false => "default"
            };

            writer.WriteLine("/// <inheritdoc/>");
            writer.WriteGeneratedAttributes(GeneratorName);
            writer.WriteLine($"static ComputeWeave.D2D1.D2D1PixelOptions global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.PixelOptions => {pixelOptionsExpression};");
        }
    }
}