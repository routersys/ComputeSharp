...
partial class D2DPixelShaderDescriptorGenerator
{
    ...
    private static class ConstantBuffer
    {
        ...
        public static void WriteLoadConstantBufferSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.WriteLine($"void global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{typeName}>.LoadConstantBuffer<TLoader>(in {typeName} shader, ref TLoader loader)");
            ...
            using (writer.WriteBlock())
            {
                ...
                else
                {
                    ...
                    writer.WriteLine("global::System.Runtime.CompilerServices.Unsafe.SkipInit(out global::ComputeWeave.D2D1.Generated.ConstantBuffer buffer);");
                    writer.WriteLine();
                    writer.WriteLine("global::System.Runtime.InteropServices.NativeMemory.Clear(&buffer, (uint)sizeof(global::ComputeWeave.D2D1.Generated.ConstantBuffer));");
                    writer.WriteLine();

                    // Otherwise, pass a span into the marshalled native layout buffer
                    writer.WriteLine("global::ComputeWeave.D2D1.Generated.ConstantBufferMarshaller.FromManaged(in shader, out buffer);");
                    writer.WriteLine();
                    writer.WriteLine("loader.LoadConstantBuffer(new global::System.ReadOnlySpan<byte>(&buffer, sizeof(global::ComputeWeave.D2D1.Generated.ConstantBuffer)));");
                }
            }
        }
        ...
        public static void WriteCreateFromConstantBufferSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.WriteGeneratedAttributes(GeneratorName);
            writer.WriteLine("[global::System.Runtime.CompilerServices.SkipLocalsInit]");
            writer.WriteLine($"static {typeName} global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{typeName}>.CreateFromConstantBuffer(global::System.ReadOnlySpan<byte> data)");
            ...
            using (writer.WriteBlock())
            {
                ...
                writer.WriteLine("ref readonly global::ComputeWeave.D2D1.Generated.ConstantBuffer buffer = ref global::System.Runtime.InteropServices.MemoryMarshal.AsRef<global::ComputeWeave.D2D1.Generated.ConstantBuffer>(data);");
                writer.WriteLine();
                writer.WriteLine("return global::ComputeWeave.D2D1.Generated.ConstantBufferMarshaller.ToManaged(in buffer);");
            }
        }
    }
}