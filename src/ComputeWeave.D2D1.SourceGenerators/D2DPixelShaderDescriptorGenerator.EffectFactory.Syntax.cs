...
partial class D2DPixelShaderDescriptorGenerator
{
    ...
    private static class EffectFactory
    {
        ...
        public static void WriteSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.WriteLine($"static unsafe nint global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.EffectFactory");
            ...
            using (writer.WriteBlock())
            {
                ...
                using (writer.WriteBlock())
                {
                    writer.WriteLine($$"""
                        ...
                        {
                            return global::ComputeWeave.D2D1.Interop.D2D1PixelShaderEffect.CreateEffectUnsafe<{{info.Hierarchy.Hierarchy[0].QualifiedName}}>(effectImpl);
                        }
