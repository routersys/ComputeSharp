...
partial class D2DPixelShaderDescriptorGenerator
{
    ...
    private static partial class InputDescriptions
    {
        ...
        public static void WriteSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.Write($"static global::System.ReadOnlyMemory<global::ComputeWeave.D2D1.Interop.D2D1InputDescription> global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.InputDescriptions => ");
            ...
            {
                writer.WriteLine("global::ComputeWeave.D2D1.Generated.Data.InputDescriptions;");
            }
        }
        ...
        private static void AddAdditionalDataMemberUsingDirectives(D2D1ShaderInfo info, ImmutableHashSetBuilder<string> usingDirectives)
        {
            ...
            _ = usingDirectives.Add("global::ComputeWeave.D2D1");
            _ = usingDirectives.Add("global::ComputeWeave.D2D1.Interop");
        }
