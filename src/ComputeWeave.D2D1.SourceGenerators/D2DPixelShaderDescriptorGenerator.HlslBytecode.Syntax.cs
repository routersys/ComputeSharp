...
partial class D2DPixelShaderDescriptorGenerator
{
    ...
    partial class HlslBytecode
    {
        ...
        public static void WriteShaderProfileSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.WriteLine($"static ComputeWeave.D2D1.D2D1ShaderProfile global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.ShaderProfile => global::ComputeWeave.D2D1.D2D1ShaderProfile.{info.HlslInfoKey.ShaderProfile};");
        }
        ...
        public static void WriteCompileOptionsSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            string compileOptionsExpression =
                ...
                .ToString()
                .Split(',')
                .Select(static name => $"global::ComputeWeave.D2D1.D2D1CompileOptions.{name.Trim()}")
                .Aggregate("", static (left, right) => left.Length > 0 ? $"{left} | {right}" : right);

            writer.WriteLine("/// <inheritdoc/>");
            writer.WriteGeneratedAttributes(GeneratorName);
            writer.WriteLine($"static ComputeWeave.D2D1.D2D1CompileOptions global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.CompileOptions => {compileOptionsExpression};");
        }
        ...
        public static void WriteHlslBytecodeSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            writer.WriteLine("/// <inheritdoc/>");
            writer.WriteGeneratedAttributes(GeneratorName);
            writer.Write($"static global::System.ReadOnlyMemory<byte> global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.HlslBytecode => ");
            ...
            {
                writer.WriteLine("global::ComputeWeave.D2D1.Generated.HlslBytecodeMemoryManager.Instance.Memory;");
            }
        }
