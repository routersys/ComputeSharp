...
partial class D2DPixelShaderDescriptorGenerator
{
    ...
    private static partial class ResourceTextureDescriptions
    {
        ...
        public static void WriteSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.Write($"static global::System.ReadOnlyMemory<global::ComputeWeave.D2D1.Interop.D2D1ResourceTextureDescription> global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.ResourceTextureDescriptions => ");
            ...
            {
                writer.WriteLine("global::ComputeWeave.D2D1.Generated.Data.ResourceTextureDescriptions;");
            }
        }
