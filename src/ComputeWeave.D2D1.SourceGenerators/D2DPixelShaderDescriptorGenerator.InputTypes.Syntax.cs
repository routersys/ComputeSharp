...
partial class D2DPixelShaderDescriptorGenerator
{
    ...
    partial class InputTypes
    {
        ...
        public static void WriteSyntax(D2D1ShaderInfo info, IndentedTextWriter writer)
        {
            ...
            writer.Write($"static global::System.ReadOnlyMemory<global::ComputeWeave.D2D1.Interop.D2D1PixelShaderInputType> global::ComputeWeave.D2D1.Descriptors.ID2D1PixelShaderDescriptor<{info.Hierarchy.Hierarchy[0].QualifiedName}>.InputTypes => ");
            ...
            {
                writer.WriteLine("global::ComputeWeave.D2D1.Generated.InputTypesMemoryManager.Instance.Memory;");
            }
        }
