...
internal static class HostResourceCollector
{
        ...
        ref readonly ImmutableArrayBuilder<UnorderedInternalResourceContract> resourceBuilder)
    {
        if (!fieldSymbol.IsReadOnly ||
            !PipelineResourceContractReader.TryRead(attribute, out ComputeResourceAccess access, out bool hasRecovery, out ComputeResourceRecovery recovery))
        {
            return false;
        }
        ...
        resourceBuilder.Add(new UnorderedInternalResourceContract(
            ...
            fieldSymbol.Type.GetFullyQualifiedName(includeGlobal: true),
            access,
        ...
        ref readonly ImmutableArrayBuilder<UnorderedInternalResourceContract> resourceBuilder)
    {
        ...
        slotBuilder.Add(new OwnedSlotContractInfo(
            ...
            GeneratedAccessibility.GetKeyword(resourceTypeSymbol),
        ...
        ref readonly ImmutableArrayBuilder<UnorderedInternalResourceContract> resourceBuilder)
    {
        ...
        slotBuilder.Add(new OwnedSlotContractInfo(
            ...
            GeneratedAccessibility.GetKeyword(groupSymbol),
            ResourceOwnershipKind.OwnedGroupSlot,
