...
public sealed class RawExternalViewEscapeAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static context =>
        {
            ...
            if (context.Compilation.GetTypeByMetadataName("ComputeSharp.BorrowedExternalTextureView`1") is not { } borrowedViewSymbol ||
                context.Compilation.GetTypeByMetadataName("ComputeSharp.ExternalTextureLease`1") is not { } leaseSymbol)
            {
                return;
            }
