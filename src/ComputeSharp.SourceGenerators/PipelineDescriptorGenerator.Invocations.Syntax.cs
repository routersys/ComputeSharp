...
partial class PipelineDescriptorGenerator
{
    ...
    private static void WriteHostInvocation(string hostTypeName, PipelineInvocationSyntaxInfo invocation, IndentedTextWriter writer)
    {
        ...
        writer.Write($"{invocation.Accessibility} global::ComputeSharp.ComputeSubmission {invocation.MethodName}(");
    ...
    private static void WriteInvocationType(string hostTypeName, PipelineInvocationSyntaxInfo invocation, IndentedTextWriter writer)
    {
        ...
        writer.WriteGeneratedAttributes(GeneratorName);
        writer.WriteLine($"private readonly struct {invocation.InvocationTypeName} : global::ComputeSharp.IComputePipelineInvocation");
        ...
        using (writer.WriteBlock())
        {
            ...
            writer.WriteLine();
            writer.WriteLine("/// <inheritdoc/>");
            writer.WriteLine("public void Bind(ref global::ComputeSharp.ComputePipelineBinder binder)");
            ...
            writer.WriteLine();
            writer.WriteLine("/// <inheritdoc/>");
            writer.WriteLine("public void Record(in global::ComputeSharp.ComputeContext context)");
    ...
    private static void WriteBinding(int index, PipelineBindingSyntaxInfo binding, IndentedTextWriter writer)
    {
        ...
        {
            writer.WriteLine(
                $"global::ComputeSharp.ComputeResourceBinding<{binding.ResourceTypeName}> binding{index} = " +
