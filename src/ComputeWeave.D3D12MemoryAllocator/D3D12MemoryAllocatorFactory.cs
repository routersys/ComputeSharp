...
using ComputeWeave.D3D12MemoryAllocator.Interop;
using ComputeWeave.Win32;

namespace ComputeWeave.D3D12MemoryAllocator;
...
public sealed unsafe class D3D12MemoryAllocatorFactory : ICustomQueryInterface
{
    ...
    /// </summary>
    /// <remarks>
    /// The resulting object should only be used to provide an argument for <see cref="ComputeWeave.Interop.AllocationServices.ConfigureAllocatorFactory"/>.
    /// </remarks>
