...
namespace ComputeWeave.D2D1.Tests
{
    ...
    public partial class D2D1PixelShaderTests
    {
        ...
        // See https://github.com/routersys/ComputeWeave/issues/647
        [D2DInputCount(0)]
        [D2DShaderProfile(D2D1ShaderProfile.PixelShader50)]
        [D2DGeneratedPixelShaderDescriptor]
        ...
        // See https://github.com/routersys/ComputeWeave/issues/323
        [TestMethod]
        ...
        // https://github.com/routersys/ComputeWeave/issues/727
        [TestMethod]
        public unsafe void ShaderWithComputeWeaveBoolInstanceField_IsMarshalledCorrectly()
        {
            Assert.AreEqual(4, D2D1PixelShader.GetConstantBufferSize<ShaderWithComputeWeaveBoolInstanceField>());

            ShaderWithComputeWeaveBoolInstanceField shader = new(true);

            ReadOnlyMemory<byte> memory = D2D1PixelShader.GetConstantBuffer(in shader);

            ShaderWithComputeWeaveBoolInstanceField roundTrip = D2D1PixelShader.CreateFromConstantBuffer<ShaderWithComputeWeaveBoolInstanceField>(memory.Span);
        ...
        [D2DGeneratedPixelShaderDescriptor]
        [AutoConstructor]
        internal readonly partial struct ShaderWithComputeWeaveBoolInstanceField : ID2D1PixelShader
        {
        ...
        // See https://github.com/routersys/ComputeWeave/issues/808
        [TestMethod]
