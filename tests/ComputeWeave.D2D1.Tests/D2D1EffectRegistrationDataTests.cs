...
public partial class D2D1EffectRegistrationDataTests
{
    ...
    public unsafe void EffectRegistrationData_Validate()
    {
        ...
        Assert.AreEqual(Guid.Parse("FFCC7D87-8799-7AD1-CB10-609170202A65"), effectId);
    ...
    [D2DInputCount(0)]
    [D2DGeneratedPixelShaderDescriptor]
    internal readonly partial struct TestRegistrationBlobWithOneResourceTexture : ID2D1PixelShader
    {
        [D2DResourceTextureIndex(0)]
        ...
        public float4 Execute()
        {
            return this.source.Sample(0.5f, 0.5f);
        }
    }
}
