...
public partial class D2D1ResourceTextureManagerTests
{
    ...
    public unsafe void UpdateResourceTexture2D_ConcurrentAccess_DoesNotDeadlock()
    {
        ...
        // An exception leaving either worker would end the process rather than the test, taking
        // the rest of the run with it. Capture the first one and rethrow it on the calling thread.
        ...
        Thread threadA = new(() => Run(UpdateResourceTexture));
        Thread threadB = new(() => Run(Draw));
