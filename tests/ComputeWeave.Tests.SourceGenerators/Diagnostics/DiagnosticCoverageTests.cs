...
/// <summary>
/// Holds every shipped diagnostic of the compute generators to having a test that names it.
/// </summary>
/// <remarks>
/// <para>
...
public class DiagnosticCoverageTests
{
    ...
    {
        ["CMPW0002"] = "The descriptor is declared and reported from nowhere, as it already was upstream.",
        ["CMPW0003"] = "The descriptor is declared and reported from nowhere, as it already was upstream.",
        ["CMPW0045"] = "Reported only when the shader compiler fails without a message, which no input produces."
    };
