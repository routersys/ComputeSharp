...
public class SlotDeclarationTests
{
    ...
    {
        Assert.AreEqual(
            "ComputeWeave.ComputeResourceSlot`1[ComputeWeave.ReadWriteBuffer`1[System.Int32]]",
    ...
    {
        Assert.AreEqual(
            "ComputeWeave.ComputeResourceGroupSlot`1[Ukiyoe.Grid]",
    ...
    {
        Assert.AreEqual(
            "ComputeWeave.ReadWriteBuffer`1[System.Single]",
    ...
    {
        Assert.AreEqual(
            "ComputeWeave.SharedTextureSlot`3[ComputeWeave.Bgra32,ComputeWeave.Float4,Ukiyoe.ExternalView]",
