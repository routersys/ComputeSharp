...
using RuntimeAlphaMode = runtime::ComputeWeave.ComputeAlphaMode;
using RuntimeDescriptorKind = runtime::ComputeWeave.Graphics.Pipelines.DescriptorKind;
using RuntimeDescriptorReader = runtime::ComputeWeave.Graphics.Pipelines.PipelineDescriptorReader;
using RuntimeDescriptorSet = runtime::ComputeWeave.Graphics.Pipelines.PipelineDescriptorSet;
using RuntimeHostDescriptor = runtime::ComputeWeave.Graphics.Pipelines.PipelineHostDescriptor;
using RuntimeOwnedSlotDescriptor = runtime::ComputeWeave.Graphics.Pipelines.OwnedSlotDescriptor;
using RuntimePipelineDescriptor = runtime::ComputeWeave.Graphics.Pipelines.PipelineDescriptor;
using RuntimeResourceContractDescriptor = runtime::ComputeWeave.Graphics.Pipelines.ResourceContractDescriptor;
using RuntimeResourceSetDescriptor = runtime::ComputeWeave.Graphics.Pipelines.InteropResourceSetDescriptor;
using RuntimeSharedTextureDescriptor = runtime::ComputeWeave.Graphics.Pipelines.SharedTextureContractDescriptor;
...
public class PipelineDescriptorWriterTests
{
    ...
    private static byte[] MinimalHostHash()
    {
        return
        [
            0xB7, 0x5C, 0x38, 0x8C, 0x21, 0x20, 0x66, 0x9B, 0xCE, 0xFE, 0xBB, 0x6D, 0xE3, 0x60, 0xBB, 0x54,
            0x03, 0x83, 0x29, 0xAB, 0xF0, 0xCF, 0xE2, 0xE3, 0xCF, 0x1E, 0x07, 0xC5, 0x67, 0xB3, 0xCC, 0xFA
        ];
    }
    ...
    public void ReadsWrittenResourceSetDescriptor()
    {
        ...
        Assert.AreEqual("ComputeWeave.ReadWriteTexture2D`2[ComputeWeave.Bgra32,ComputeWeave.Float4]", output.ResourceTypeMetadataName);
