...
public class PipelineCanonicalOrderingTests
{
    ...
    private static OwnedSlotContractInfo Slot(string memberMetadataName)
    {
        return new OwnedSlotContractInfo(
            ...
            "global::ComputeWeave.ReadWriteBuffer<int>",
            "public",
    ...
    private static SharedTextureContractInfo SharedTexture(string memberMetadataName)
    {
        return new SharedTextureContractInfo(
            uint.MaxValue,
            memberMetadataName,
            "ComputeWeave.Interop.ComputeSharedTexture2D`1",
            "global::ComputeWeave.Bgra32",
            "global::ComputeWeave.Float4",
            "global::Ukiyoe.ExternalView",
            "public",
            "public",
    ...
    public void OrdersPipelinesBySignatureAndAssignsOrdinals()
    {
        EquatableArray<PipelineContractInfo> pipelines = ImmutableArray.Create(
            Pipeline("Second", "H|Second|00000000|System.Void|00000001|03:ComputeWeave.ComputeContext"),
            Pipeline("First", "H|First|00000000|System.Void|00000001|03:ComputeWeave.ComputeContext"));
    ...
    {
        PipelineContractInfo first = Pipeline("A", "H|A|00000000|System.Void|00000001|03:ComputeWeave.ComputeContext");
        PipelineContractInfo second = Pipeline("B", "H|B|00000000|System.Void|00000001|03:ComputeWeave.ComputeContext");
        PipelineContractInfo third = Pipeline("C", "H|C|00000000|System.Void|00000001|03:ComputeWeave.ComputeContext");
    ...
    {
        const string Signature = "H|A|00000000|System.Void|00000001|03:ComputeWeave.ComputeContext";
