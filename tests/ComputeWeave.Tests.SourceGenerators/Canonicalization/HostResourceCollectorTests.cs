...
public class HostResourceCollectorTests
{
    ...
    private const string HostUsings = "using ComputeWeave;";
    ...
    public void CollectsBorrowedFieldWithoutSlot()
    {
        ...
        Assert.AreEqual("ComputeWeave.ReadOnlyBuffer`1[System.Single]", resource.ResourceTypeMetadataName);
    ...
    public void CollectsOwnedSlotWithZeroResourceIndex()
    {
        ...
        Assert.AreEqual("ComputeWeave.ReadWriteTexture2D`2[ComputeWeave.Bgra32,ComputeWeave.Float4]", slot.ResourceTypeMetadataName);
        ...
        Assert.AreEqual("ComputeWeave.ReadWriteTexture2D`2[ComputeWeave.Bgra32,ComputeWeave.Float4]", resource.ResourceTypeMetadataName);
    }
