...
public class CanonicalTypeNameBuilderTests
{
    ...
    {
        Assert.AreEqual("ComputeWeave.ReadWriteBuffer`1[System.Int32]", CanonicalName("IntBuffer"));
        Assert.AreEqual("ComputeWeave.ReadWriteBuffer`1[System.Single]", CanonicalName("FloatBuffer"));
    ...
    {
        Assert.AreEqual(
            "System.Collections.Generic.Dictionary`2[System.String,ComputeWeave.ReadWriteBuffer`1[System.Int32]]",
