...
public class PipelineCanonicalSignatureValidatorTests
{
    ...
    private const string Context = "03:ComputeWeave.ComputeContext";
    ...
    {
        Validate($"{Host}|{Method}|00000000|System.Void|00000002|{Context}|00:ComputeWeave.ReadWriteBuffer`1[System.Int32]");
    }
    ...
    public void RejectsFirstParameterWithoutContext()
    {
        ...
        AssertRejected($"{Host}|{Method}|00000000|System.Void|00000001|00:ComputeWeave.ComputeContext");
    }
    ...
    {
        AssertRejected($"{Host}|{Method}|00000000|System.Void|00000001|03ComputeWeave.ComputeContext");
