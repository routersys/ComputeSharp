...
{
    private const string CanonicalSignature = "H|M|00000000|System.Void|00000001|03:ComputeWeave.ComputeContext";
    ...
    private static byte[] InteropHostDescriptor()
    {
        ...
        WriteInt32(payload, 0);
        WriteString(payload, "ComputeWeave.ReadWriteTexture2D`2[ComputeWeave.Bgra32,ComputeWeave.Float4]");
