...
{
    private const string TextureTypeMetadataName = "ComputeWeave.ReadWriteTexture2D`2[ComputeWeave.Bgra32,ComputeWeave.Float4]";
    ...
    {
        _ = Assert.ThrowsException<InvalidDataException>(
            () => PipelineExternalBindingValidator.Validate(Parameter(resourceTypeMetadataName: "ComputeWeave.ReadWriteBuffer`1[System.Int32]"), SharedTexture()));
    }
