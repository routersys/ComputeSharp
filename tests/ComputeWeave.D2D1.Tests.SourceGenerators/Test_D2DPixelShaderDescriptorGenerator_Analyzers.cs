...
public class Test_D2DPixelShaderDescriptorGenerator_Analyzers
{
    ...
    public async Task AllowsUnsafeBlocksNotEnabled_Warns()
    {
        const string source = """
            ...
            [{|CMPWD2D0064:D2DGeneratedPixelShaderDescriptor|}]
    ...
    public async Task MissingD2DPixelShaderDescriptor_Warns()
    {
        const string source = """
            ...
            internal partial struct {|CMPWD2D0065:MyShader|} : ID2D1PixelShader
            {
                public Float4 Execute()
                {
                    return 0;
    ...
    public async Task NotReadOnlyShaderType_WithFields_Warns()
    {
        const string source = """
            ...
            internal partial struct {|CMPWD2D0070:MyShader|} : ID2D1PixelShader
            {
                public float number;
    ...
    public async Task InvalidD2DGeneratedPixelShaderDescriptorAttributeTarget_NoInterface()
    {
        const string source = """
            ...
            [{|CMPWD2D0066:D2DGeneratedPixelShaderDescriptor|}]
    ...
    public async Task ShaderWithNoPrecompiledBytecode_WithNoD2DEnableRuntimeCompilation_Warns()
    {
        const string source = """
            ...
            internal partial struct {|CMPWD2D0076:MyType|} : ID2D1PixelShader
            {
                public Float4 Execute()
                {
                    return 0;
    ...
    public async Task ShaderWithNoPrecompiledBytecode_WithUnnecessaryD2DEnableRuntimeCompilation_Warns()
    {
        const string source = """
            ...
            [D2DInputCount(0)]
            [{|CMPWD2D0077:D2DEnableRuntimeCompilation|}]
            [D2DGeneratedPixelShaderDescriptor]
            internal partial struct MyType : ID2D1PixelShader
            {
                public Float4 Execute()
    ...
    public async Task ShaderWithPrecompiledBytecode_FromAssembly_WithUnnecessaryD2DEnableRuntimeCompilation_Warns()
    {
        const string source = """
            ...
            [D2DInputCount(0)]
            [{|CMPWD2D0078:D2DEnableRuntimeCompilation|}]
            [D2DGeneratedPixelShaderDescriptor]
            internal partial struct MyType : ID2D1PixelShader
            {
                public Float4 Execute()
    ...
    public async Task UnnecessaryD2DEnableRuntimeCompilation_OnAssembly_Warns()
    {
        const string source = """
            ...
            [assembly: D2DShaderProfile(D2D1ShaderProfile.PixelShader50)]
            [assembly: {|CMPWD2D0079:D2DEnableRuntimeCompilation|}]
            """;
    ...
    public async Task ShaderWithNoPrecompiledBytecode_WithD2DRequiresDoublePrecisionSupport_Warns()
    {
        const string source = """
            ...
            [D2DInputCount(0)]
            [{|CMPWD2D0082:D2DRequiresDoublePrecisionSupport|}]
            [D2DGeneratedPixelShaderDescriptor]
            internal partial struct MyType : ID2D1PixelShader
            {
                public Float4 Execute()
    ...
    public async Task MissingD2DResourceTextureIndexAttribute_WarnsOnlyIfMissing()
    {
        const string source = """
            ...
            internal partial struct MyType : ID2D1PixelShader
            {
                public D2D1ResourceTexture1D<float> {|CMPWD2D0050:texture1D|};
                public D2D1ResourceTexture2D<float> {|CMPWD2D0050:texture2D|};
                public D2D1ResourceTexture3D<float> {|CMPWD2D0050:texture3D|};
    ...
    public async Task ResourceTextureIndexOverlappingWithInputIndex_Warns()
    {
        const string source = """
            ...
            [D2DInputCount(2)]
            internal partial struct {|CMPWD2D0046:MyType|} : ID2D1PixelShader
            {
                [D2DResourceTextureIndex(1)]
    ...
    public async Task OutOfRangeResourceTextureIndex_Warns()
    {
        const string source = """
            ...
            [D2DInputCount(0)]
            internal partial struct {|CMPWD2D0047:MyType|} : ID2D1PixelShader
            {
    ...
    public async Task RepeatedD2DResourceTextureIndices_Warns()
    {
        const string source = """
            ...
            [D2DInputCount(0)]
            internal partial struct {|CMPWD2D0048:MyType|} : ID2D1PixelShader
            {
                [D2DResourceTextureIndex(0)]
    ...
    public async Task InvalidD2DResourceTextureIndices_MultipleErrors_WarnsOncePerDiagnosticId()
    {
        const string source = """
            ...
            [D2DInputCount(3)]
            internal partial struct {|CMPWD2D0046:{|CMPWD2D0047:{|CMPWD2D0048:MyType|}|}|} : ID2D1PixelShader
            {
                [D2DResourceTextureIndex(0)]
                public D2D1ResourceTexture1D<float> texture1;
    ...
    public async Task InvalidPackMatrixColumnMajorOption_AssemblyLevel_WithColumnMajor_Warns()
    {
        const string source = """
            ...
            [assembly: {|CMPWD2D0044:D2DCompileOptions(D2D1CompileOptions.PackMatrixColumnMajor)|}]
            """;
    ...
    public async Task InvalidPackMatrixColumnMajorOption_ShaderType_WithColumnMajor_Warns()
    {
        const string source = """
            ...
            [D2DInputCount(0)]
            [{|CMPWD2D0044:D2DCompileOptions(D2D1CompileOptions.PackMatrixColumnMajor)|}]
            internal partial struct MyType : ID2D1PixelShader
            {
                public Float4 Execute()
                {
    ...
    public async Task ExceededDispatchDataSize_ConstantBufferTooLarge_Warns()
    {
        const string source = """
            using ComputeWeave.D2D1;
            using float1x3 = ComputeWeave.Float1x3;
            using float2x2 = ComputeWeave.Float2x2;
            using float3x2 = ComputeWeave.Float3x2;
            using float4x3 = ComputeWeave.Float4x3;
            using float4x4 = ComputeWeave.Float4x4;
            using float2 = ComputeWeave.Float2;
            using float3 = ComputeWeave.Float3;
            ...
            [D2DInputCount(0)]
            internal readonly partial struct {|CMPWD2D0032:MyType|}(Data4 data4) : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return data4.s0;
    ...
    public async Task OutOfRangeInputDescriptionIndex_Warns()
    {
        const string source = """
            ...
            internal readonly partial struct {|CMPWD2D0042:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task RepeatedD2DInputDescriptionIndices_Warns()
    {
        const string source = """
            ...
            [D2DInputDescription(0, D2D1Filter.MinMagMipPoint)]
            internal readonly partial struct {|CMPWD2D0043:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task InvalidInputDescriptions_MultipleErrors_WarnsOncePerDiagnosticId()
    {
        const string source = """
            ...
            internal readonly partial struct {|CMPWD2D0042:{|CMPWD2D0043:MyType|}|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task MissingD2DInputCountAttribute_Warns()
    {
        const string source = """
            ...
            internal readonly partial struct {|CMPWD2D0058:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task InvalidD2DInputCount_Warns(int inputCount)
    {
        string source = $$"""
            ...
            internal readonly partial struct {|CMPWD2D0035:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task OutOfRangeInputIndex_NoInputs_Warns(string inputType)
    {
        string source = $$"""
            ...
            internal readonly partial struct {|CMPWD2D0039:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task RepeatedD2DInputSimpleIndices_Warns()
    {
        const string source = """
            ...
            [D2DInputSimple(1)]
            [D2DInputSimple(3)]
            internal readonly partial struct {|CMPWD2D0036:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task RepeatedD2DInputComplexIndices_Warns()
    {
        const string source = """
            ...
            [D2DInputComplex(1)]
            [D2DInputComplex(3)]
            internal readonly partial struct {|CMPWD2D0037:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task InvalidSimpleAndComplexIndicesCombination_Warns()
    {
        const string source = """
            ...
            [D2DInputComplex(2)]
            [D2DInputComplex(5)]
            internal readonly partial struct {|CMPWD2D0038:MyType|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task InvalidInputTypes_MultipleErrors_WarnsOncePerDiagnosticId()
    {
        const string source = """
            ...
            [D2DInputComplex(99)]
            [D2DInputComplex(1)]
            internal readonly partial struct {|CMPWD2D0035:{|CMPWD2D0039:{|CMPWD2D0036:{|CMPWD2D0037:{|CMPWD2D0038:MyType|}|}|}|}|} : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return 0;
    ...
    public async Task IndexOutOfRangeForD2DIntrinsic_InvalidArgument1_Warns(int index)
    {
        string source = $$"""
            ...
            internal readonly partial struct MyType : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return D2D.GetInput({|CMPWD2D0083:{{index}}|});
                }
            }
            """;
    ...
    public async Task IndexOutOfRangeForD2DIntrinsic_InvalidArgument2_Warns()
    {
        const string source = """
            ...
            internal readonly partial struct MyType : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    return D2D.GetInput({|CMPWD2D0086:{|CMPWD2D0083:-1|}|});
                }
            }
            """;
    ...
    public async Task InvalidInputTypeForD2DIntrinsic_InvalidArguments_Warns()
    {
        const string source = """
            ...
            internal readonly partial struct MyType : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    D2D.GetInputCoordinate({|CMPWD2D0084:0|});
                    D2D.SampleInput({|CMPWD2D0084:0|}, 0);
                    D2D.SampleInputAtOffset({|CMPWD2D0084:0|}, 0);
                    D2D.SampleInputAtPosition({|CMPWD2D0084:0|}, 0);
    ...
    public async Task InvalidInputTypeForD2DIntrinsic_InvalidSyntax_Warns()
    {
        const string source = """
            ...
            internal readonly partial struct MyType : ID2D1PixelShader
            {
                ...
                public float4 Execute()
                {
                    D2D.GetInput({|CMPWD2D0086:+1|});
                    D2D.GetInput({|CMPWD2D0086:-0|});
                    D2D.GetInput({|CMPWD2D0086:(1)|});
                    D2D.GetInput({|CMPWD2D0086:BaseIndex + 1|});
                    D2D.GetInput({|CMPWD2D0086:0 + 1|});
    ...
    public async Task NonConstantSourceInputIndexForD2DIntrinsic_NonConstantExpression_Warns()
    {
        const string source = """
            ...
            internal readonly partial struct MyType(int x) : ID2D1PixelShader
            {
                public float4 Execute()
                {
                    D2D.GetInput({|CMPWD2D0085:x|});
                    D2D.GetInputCoordinate({|CMPWD2D0085:x|});
                    D2D.SampleInput({|CMPWD2D0085:x|}, 0);
                    D2D.SampleInputAtOffset({|CMPWD2D0085:x|}, 0);
                    D2D.SampleInputAtPosition({|CMPWD2D0085:x|}, 0);
