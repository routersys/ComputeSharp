...
| Generated HLSL, reserved identifiers | Reserves a partial set of the Shader Model 5 resource type names, so a captured field named after any other reserved identifier reaches the compiler unrenamed and fails | Reserves the 283 names measured to collide, found by testing every identifier-like string in the compiler binary | `46e199b3`, `1bcce681` |
