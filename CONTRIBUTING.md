...
| `Hlsl.Sign` | Declares Float and Int only, though HLSL accepts a double there and the closely related `Abs` already declares Double | Declares Float, Int and Double, so a sign reaches as far as the `Abs` beside it | `c08ed644` |
